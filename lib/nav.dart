import 'package:daleh_appswebvie/widget/shear.dart';
    ...
    return SafeArea(
      child: Scaffold(
        body: PageView(
          ...
          children: <Widget>[
            Container(
              child: HomePage1('https://aldananews.com/'),
            ),
            Container(
              child: HomePage1(
                  'https://aldananews.com/category/%d9%85%d8%ac%d9%84%d8%b3-%d8%a7%d9%84%d8%a3%d9%85%d8%a9/'),
            ),
            Container(
              child:
                  HomePage1('https://aldananews.com/category/editors-picks/'),
            ),
            Shear()
          ],
        ),
